...
\midrule
Claude Code (Anthropic),\newline VS-Code-Extension, Modell Claude~Sonnet~5
  & Python-Code-Unterstützung (NVIDIA-Isaac-Sim-Extension), Strukturierung und Verwaltung des Literatur- und Dokumentenordners, Erstellung der Abbildung zum Aufbau des Digitalen Zwillings vom URDF-Import bis zur NVIDIA Isaac Sim Szene sowie der UML-Diagramme zur Datenflussstruktur der Dobot-Magician-Extension
...
Diese Anleitung liegt als PowerPoint-Foliensatz vor und stellt gemeinsam mit der technischen Dokumentation des Dobot Magician die vollständige Reproduzierbarkeit beider Anlagen sicher.
