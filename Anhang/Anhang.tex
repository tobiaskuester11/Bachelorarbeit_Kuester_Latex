...
Claude Code (Anthropic),\newline VS-Code-Extension, Modell Claude~Sonnet~5
  & Python-Code-Unterstützung (Omniverse-Extension), Strukturierung und Verwaltung des Literatur- und Dokumentenordners, Erstellung der Abbildung zum Aufbau des Digitalen Zwillings vom URDF-Import bis zur NVIDIA Isaac Sim Szene
