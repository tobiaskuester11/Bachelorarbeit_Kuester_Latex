...
\begin{itemize}
    ...
    \item \textbf{VR-Integration:} Der Digitale Schatten des Dobot kann auf der Meta Quest~3 immersiv inspiziert werden. Zukünftig ist eine VR-gestützte Programmierung denkbar, bei der Bewegungsabläufe in der virtuellen Umgebung definiert und anschließend auf den realen Roboter übertragen werden.
\end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{VR-Lehrformat ausbauen:} Nutzung der Meta-Quest-3-Demonstration als interaktives Lehrformat. Eine Verbindung mit Game-Engine-Exporten (z.\,B.\ via Omniverse-USD-to-Unreal-Konnektor) erweitert die Geräteverfügbarkeit.
